...
for dataset_id in [1471, 1502, 40922, 43551, 1461, 1590, 41138, 42395]:
    try:
        ...
        for i, (ind_learn, ind_test) in enumerate(sss.split(X, y)):
            ...
            X_learn, X_test = X[ind_learn], X[ind_test]
            ...
            for ind_train, _ in isss(X_learn, y_learn):
                X_train = X_learn[ind_train]
